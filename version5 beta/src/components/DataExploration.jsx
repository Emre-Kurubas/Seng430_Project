            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
                ...
                <div className="lg:col-span-4 space-y-6">
                    ...
                    <div className={'p-5 rounded-xl border shadow-sm ' + (isDarkMode ? 'bg-slate-800/50 border-slate-700' : 'bg-white border-slate-200')}>
                        ...
                        {useDefaultDataset && (
                            <div className={'mb-4 p-3 rounded-lg border ' + (isDarkMode ? 'bg-slate-900/50 border-slate-700' : 'bg-slate-50 border-slate-200')}>
                                ...
                                {showGuide && (
                                    ...
                                    >
                                        ...
                                        <div className="space-y-1.5">
                                            <p>✅ <strong>First row</strong> must be column headers (e.g., Age, BloodPressure)</p>
                                            <p>✅ <strong>Last column</strong> should be the target variable (what to predict)</p>
                                            <p>✅ <strong>Values</strong> should be numeric measurements or categories</p>
                                            <p>❌ <strong>Avoid</strong> images, free-text, or patient identifiers (ID columns)</p>
                                            <p>📎 Supported: <code className={'px-1 py-0.5 rounded ' + (isDarkMode ? 'bg-slate-800' : 'bg-white')}>.csv</code> only, max 50 MB</p>
                                        </div>
