        ...
        <div className="w-full space-y-6 pb-20">
            ...
            {results && (
                <>
                    ...
                    {/* ── Retrain Button ── */}
                    {results && (
                        <div className={`p-5 rounded-2xl border flex flex-col sm:flex-row items-center justify-between gap-4 ${isDarkMode ? 'bg-indigo-900/15 border-indigo-500/25' : 'bg-indigo-50 border-indigo-200'}`}>
                            <div>
                            ...
                            <button
                                ...
                                className={`shrink-0 flex items-center gap-2 px-5 py-2.5 rounded-xl font-bold text-sm transition-all hover:scale-105 active:scale-95 shadow-md
                                    ${isDarkMode
