...
import {
    ...
    Check, Square, ChevronDown, ChevronUp, Award, Sparkles
} from 'lucide-react';
...
const SubgroupRow = ({ group, acc, sens, spec, overall, isDarkMode, delay, isRef }) => {
...
const ChecklistItem = ({ item, checked, onToggle, isDarkMode, delay }) => {
...
const CaseStudyCard = ({ cs, isDarkMode, delay }) => {
    const colors = {
...
const RepBar = ({ label, trainingPct, hospitalPct, isDarkMode, delay }) => {
