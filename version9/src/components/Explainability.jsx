        ...
        <div style={{ marginBottom: 20 }}>
            <div style={{ display: 'flex', justifyItems: 'center', justifyContent: 'space-between', marginBottom: 6 }}>
                <div style={{ display: 'flex', flexDirection: 'column' }}>
                  ...
                  <span style={{ fontSize: '0.7rem', color: 'var(--text-tertiary)' }}>{clinical}</span>
                </div>
                <span style={{ fontSize: '0.9rem', fontWeight: 700, color: color }}>{importance.toFixed(2)}</span>
            </div>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
                    ...
                    <div className="lg:col-span-5 flex flex-col gap-6">
                        ...
                        {!loadingFeatures && top1 && (
                            ...
                            >
                                ...
                                <div style={{ fontSize: '1rem', color: 'var(--text-sec)', marginTop: 12, maxWidth: 400, margin: '12px auto 0' }}>
                                    Accounts for the majority of the model's decision-making process.
                                </div>
                            </motion.div>
                        )}
                            ...
                            {loadingFeatures ? (
                                ...
                                <div className="space-y-3 relative z-10 flex-1" style={{ marginTop: 24 }}>
                                    {featureImportance.map((f, i) => (
                                        <HBar key={f.id} index={i} label={f.label} clinical={f.clinical} importance={f.importance} maxVal={maxImportance} isDarkMode={isDarkMode} delay={i * 0.07} primaryStr={primaryStr} />
                                    ))}
                                </div>
                            )}
                        ...
                        <motion.div variants={itemAnim} className="ios-card flex flex-col gap-4">
                            <div className="section-title">Individual Case</div>
                            ...
                            <label className="ios-list-title">2. Generate Insight</label>
                            <motion.button
