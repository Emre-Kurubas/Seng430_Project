...
const VisualizationsPanel = React.memo(({ isApplied, isAnimating, isDarkMode }) => {
    return (
        <>
            {/* Loading Overlay */}
            <AnimatePresence>
                            ...
                            <div className="space-y-4">
                                ...
                                <div className="space-y-3">
                                    <div className="flex items-center text-xs">
                                        ...
                                        <div className={`flex-grow h-2 rounded-full overflow-hidden ${isDarkMode ? 'bg-slate-700' : 'bg-slate-200'}`}>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
                ...
                <div className="lg:col-span-8 space-y-6">
                    ...
                    <div className={`p-6 rounded-xl border min-h-[500px] flex flex-col ${isDarkMode ? 'bg-slate-800/50 border-slate-700' : 'bg-white border-slate-200'} shadow-sm relative overflow-hidden`}>
                        ...
                        <VisualizationsPanel isApplied={isApplied} isAnimating={isAnimating} isDarkMode={isDarkMode} />
