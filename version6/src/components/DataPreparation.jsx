            ...
            <AnimatePresence>
                {isAnimating && (
                    <motion.div
                        ...
                        animate={{ opacity: 1 }}
                        exit={{ opacity: 0 }}
                        className="absolute inset-0 z-10 bg-white/10  flex flex-col items-center justify-center space-y-4"
                    >
                        <div className="relative">
                ...
                <div className="flex flex-col items-center justify-center flex-grow text-center space-y-6 py-16">
                    ...
                    <div className="relative w-28 h-28">
                        ...
                        <div className={`absolute inset-0 flex items-center justify-center`}>
                            <div className={`p-4 rounded-2xl ${isDarkMode ? 'bg-slate-800 border border-slate-700' : 'bg-slate-100 border border-slate-200'}`}>
        ...
        <motion.div variants={containerAnim} initial="hidden" animate="show" className="w-full space-y-6 pb-20">
            ...
            <motion.div variants={itemAnim} className="mb-2">
                <div className="flex items-center justify-between mb-3">
                    ...
                    <button
                        onClick={onNext}
                        disabled={!isApplied}
                        className={`flex items-center gap-2 px-4 py-2 rounded-md text-sm font-semibold transition-all ${isApplied
                            ? 'text-white hover:brightness-110'
                            : isDarkMode ? 'bg-slate-800 text-slate-500 cursor-not-allowed' : 'bg-slate-100 text-slate-400 cursor-not-allowed'
                            }`}
                        style={isApplied ? { backgroundColor: primaryStr, boxShadow: `0 2px 10px ${primaryStr}30` } : {}}
                    >
                ...
                <p className={`text-sm ${isDarkMode ? 'text-slate-400' : 'text-slate-500'}`}>
                    Clean, split, and balance your data before training.
                </p>
            </motion.div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
                ...
                <motion.div variants={itemAnim} className="lg:col-span-4 space-y-6">
                    <div className={`p-6 rounded-xl border h-full backdrop-blur-md transition-all duration-300 ${isDarkMode ? 'bg-slate-800/80 border-slate-700/60 shadow-[0_8px_30px_rgb(0,0,0,0.3)]' : 'bg-white/95 border-slate-200/60 shadow-[0_8px_30px_rgb(0,0,0,0.04)]'}`}>
                        ...
                        <div className="space-y-8">
                            ...
                            <div className="space-y-3">
                                ...
                                <p className={`text-xs p-3 rounded-lg border ${isDarkMode ? 'bg-slate-900 border-slate-700 text-slate-400' : 'bg-slate-50 border-slate-200 text-slate-500'}`}>
                            ...
                            <button
                                ...
                                className={`w-full py-3 rounded-xl font-bold text-white shadow-sm transition-all ${isAnimating
                ...
                <motion.div variants={itemAnim} className="lg:col-span-8 space-y-6">
                    ...
                    <div className={`p-6 rounded-xl border min-h-[500px] flex flex-col backdrop-blur-md transition-all duration-300 relative overflow-hidden ${isDarkMode ? 'bg-slate-800/80 border-slate-700/60 shadow-[0_8px_30px_rgb(0,0,0,0.3)]' : 'bg-white/95 border-slate-200/60 shadow-[0_8px_30px_rgb(0,0,0,0.04)]'}`}>
                    ...
                    <AnimatePresence>
                        {isApplied && (
                            <motion.div
                                ...
                                className={`p-5 rounded-xl border-2 flex gap-4 shadow-sm ${isDarkMode
            ...
            {/* Bottom Navigation */}
            <motion.div variants={itemAnim} className={`flex justify-between items-center pt-8 border-t mt-8 ${isDarkMode ? 'border-slate-800' : 'border-slate-200'}`}>
                <button
                    onClick={onPrev}
                ...
                <button
                    ...
                    style={isApplied ? { backgroundColor: primaryStr, boxShadow: `0 4px 14px ${primaryStr}30` } : {}}
                >
                    Next Step <ArrowRight className="w-4 h-4" />
                </button>
            </motion.div>
