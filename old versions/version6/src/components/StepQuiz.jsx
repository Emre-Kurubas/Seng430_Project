    ...
    if (finished) {
        return (
            <motion.div
                ...
                className={`p-6 rounded-xl border ${isDarkMode ? 'bg-slate-800 border-slate-700' : 'bg-white border-slate-200'} shadow-sm`}
            >
                <div className="text-center">
                    ...
                    <div className="flex gap-3 justify-center">
                        ...
                        <button
                            ...
                            className="flex items-center gap-2 px-6 py-2 rounded-lg text-sm font-bold bg-emerald-600 hover:bg-emerald-500 text-white transition-all shadow-sm shadow-emerald-500/20"
                        >
