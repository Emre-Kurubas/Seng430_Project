                                ...
                                <VizErrorBoundary isDarkMode={isDarkMode} key={`error-${selectedModel}`}>
                                    <AnimatePresence mode="wait">
                                        <motion.div key={selectedModel} initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -10 }} transition={{ duration: 0.3 }}>
                                            <ModelVisualizer selectedModel={selectedModel} params={params} isDarkMode={isDarkMode} datasetSchema={datasetSchema} targetColumn={targetColumn} domain={domain} dataset={dataset} trainedModelResult={lastResult} />
                                        </motion.div>
                                    </AnimatePresence>
                                </VizErrorBoundary>
                                {trainError && (
