...
/** @description Scroll arrow button for the domain pill strip */
const ArrowBtn = ({ onClick, dir, isDarkMode }) => (
    <button
        onClick={onClick}
        type="button"
        aria-label={dir === 'left' ? 'Scroll specialties left' : 'Scroll specialties right'}
 ...
 * @description Horizontal scrollable pill bar allowing selection of one of 20 medical specialties.
 * @param {Object} props
 * @param {Object} props.activeDomain - Currently selected specialty object
 * @param {Function} props.onDomainChange - Callback fired with the new specialty object
    ...
    return (
        <div className="relative w-full">
            ...
            <div className="flex items-center gap-2 mb-2.5 pl-1">
                <div className={`p-1.5 rounded-lg w-7 h-7 flex items-center justify-center`} style={{ backgroundColor: `${primaryStr}20` }}>
                    ...
                    {specialties.map((domain) => {
                        ...
                        return (
                            <motion.button
                                ...
                                aria-label={`${domain.name} specialty`}
                                ...
                                `}
                                style={isActive ? {
                                    background: `linear-gradient(135deg, ${domain.theme?.secondary || '#10b981'} 0%, ${domain.theme?.primary || '#6366f1'} 100%)`,
                                    boxShadow: `0 4px 16px ${domain.theme?.primary || '#6366f1'}4D`,
                                } : {}}
                            >
                                ...
                                {isActive && (
                                    <motion.div
                                        ...
                                        style={{ background: `linear-gradient(135deg, ${domain.theme?.secondary || '#10b981'} 0%, ${domain.theme?.primary || '#6366f1'} 100%)` }}
