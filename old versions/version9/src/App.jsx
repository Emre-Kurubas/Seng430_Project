...
export default function App() {
  ...
  // Reset confirm action if clicked outside
  useEffect(() => {
    ...
    <AnimatePresence mode="wait">
      ...
      <div className="dashboard-container">
        ...
        <aside className="dashboard-sidebar">
            ...
            {specialties.map(spec => {
              ...
              return (
                <button
                  ...
                  onClick={() => handleDomainChange(spec)}
                >
                  <div className="nav-item-content">
                    <span style={{ fontSize: '0.9rem' }}>{spec.emoji}</span>
                    <span style={{ fontSize: '0.65rem', whiteSpace: 'nowrap', overflow: 'hidden', textOverflow: 'ellipsis' }}>{spec.name}</span>
                  </div>
                </button>
              );
            })}
          ...
          <div style={{ display: 'flex', gap: 8, justifyContent: 'center', marginTop: 'auto', paddingTop: 16, borderTop: '1px solid rgba(255,255,255,0.05)' }}>
      ...
      <div className="bottom-nav-container" style={{ position: 'fixed', bottom: 24, left: 'calc(50% + 130px)', transform: 'translateX(-50%)', zIndex: 100, display: 'flex', justifyContent: 'center', pointerEvents: 'none' }}>
        <motion.div 
