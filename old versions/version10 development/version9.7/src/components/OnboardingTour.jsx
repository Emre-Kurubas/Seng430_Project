...
const STEPS = [
    ...
    },
    {
        ...
        body: 'The progress bar shows your journey through 7 guided steps — from Clinical Scenario all the way to Fairness Checks. Steps unlock sequentially as you complete each one.',
...
const TooltipCard = ({
    ...
    return (
        <motion.div
            ...
            className={`fixed z-[210] rounded-xl border shadow-sm overflow-hidden ${isDarkMode
            ...
            <div className="p-5">
                ...
                <div className="flex items-center justify-between">
                    ...
                    <div className="flex items-center gap-2">
                        ...
                        <button
                            onClick={onNext}
                            className={`flex items-center gap-1.5 px-4 py-1.5 rounded-lg text-xs font-bold transition-colors ${isLast
...
const HighlightRing = ({ targetRect }) => {
    ...
    return (
        <motion.div
            ...
            exit={{ opacity: 0 }}
            className="fixed z-[205] pointer-events-none rounded-xl"
            style={{
