        ...
        <AnimatePresence>
            <div className="fixed inset-0 z-[9999] flex items-center justify-center p-4 sm:p-6 overflow-hidden">
                ...
                <motion.div
                    ...
                    className={`relative w-full max-w-6xl max-h-[90vh] flex flex-col rounded-xl overflow-hidden shadow-[0_0_50px_-12px_rgba(0,0,0,0.5)] ring-1 ${isDarkMode ? 'bg-slate-900 ring-white/10' : 'bg-white/95 ring-black/5'} `}
                >
                    ...
                    <div className={`relative px-8 py-6 border-b flex items-center justify-between ${isDarkMode ? 'border-slate-800' : 'border-slate-200'}`}>
                        <div className="flex items-center gap-4">
                            <div className={`p-3 rounded-xl ${isDarkMode ? 'bg-emerald-500/10 text-emerald-400' : 'bg-emerald-100 text-emerald-600'}`}>
                    ...
                    <div className="flex flex-col lg:flex-row flex-1 overflow-hidden relative z-10">
                        ...
                        <div className={`w-full lg:w-1/3 p-8 space-y-8 flex flex-col border-r overflow-y-auto ${isDarkMode ? 'border-slate-800 bg-slate-800/20' : 'border-slate-200 bg-slate-50/50'}`}>
                            ...
                            <div className="space-y-6 flex-1">
                                ...
                                {!validationSuccess && (
                                    <div className={`p-5 rounded-xl border  ${isDarkMode ? 'bg-amber-900/10 border-amber-500/20' : 'bg-amber-50 border-amber-200/50'}`}>
                                ...
                                {validationSuccess && (
                                    <motion.div
                                        ...
                                        className={`p-5 rounded-xl border  ${isDarkMode ? 'bg-emerald-900/15 border-emerald-500/25' : 'bg-emerald-50 border-emerald-200'}`}
                                    >
                            ...
                            <div className="pt-4 grid grid-cols-2 gap-3">
                                ...
                                <button
                                    ...
                                    className={`relative py-3.5 rounded-xl overflow-hidden group transition-all shadow-sm ${isValidated
                        ...
                        <div className="w-full lg:w-2/3 flex flex-col relative">
                            {/* Inner Header */}
                            <div className={`px-8 py-5 border-b flex items-center justify-between sticky top-0 z-10  ${isDarkMode ? 'border-slate-800 bg-slate-900' : 'border-slate-200 bg-white/90'}`}>
                            ...
                            <div className="flex-1 overflow-y-auto p-4 sm:p-6 space-y-3">
                                ...
                                {columns.map((col, idx) => (
                                    <motion.div
                                        key={idx}
                                        layoutId={col.name}
                                        className={`grid grid-cols-12 gap-4 items-center px-6 py-4 rounded-xl border transition-all duration-300 hover:shadow-md ${isDarkMode
                                            ? 'bg-slate-800 border-slate-700/60 hover:border-slate-500 hover:bg-slate-800'
                                        ...
                                        <div className="col-span-4 relative group">
                                            <select
                                                ...
                                                className={`w-full p-2.5 rounded-xl appearance-none text-sm font-medium cursor-pointer transition-all outline-none focus:ring-2 ${isDarkMode
                                                    ? 'bg-slate-900 border-slate-600 text-slate-200 focus:ring-indigo-500/50 hover:border-slate-400 border'
