...
const Header = ({ activeDomain, isDarkMode, toggleTheme, onHelpOpen, onReset, resetPending, onHome }) => {
    ...
    return (
        <motion.header
            ...
            className={`sticky top-0 z-50 border-b transition-colors duration-300 ${isDarkMode ? 'bg-slate-900 border-slate-700/80 shadow-sm' : 'bg-white border-slate-200 shadow-sm'}`}
        >
            <div className={`
