        ...
        <div className="space-y-6">
            ...
            {isImbalanced && (
                <motion.div
                    ...
                    className={'p-4 rounded-2xl flex gap-3 text-sm backdrop-blur-sm ' + (isDarkMode
                        ? 'bg-amber-500/[0.06] text-amber-200 border border-amber-500/20'
                        : 'bg-amber-50 text-amber-800 bg-white border border-slate-200 shadow-md/60')}
                >
    ...
    return (
        <motion.div
            ...
            className={'group relative rounded-2xl p-4 transition-all duration-300 cursor-default overflow-hidden ' + (
                isTarget
                    ? (isDarkMode ? 'bg-slate-800/80 ring-1 ring-inset shadow-lg' : 'ring-1 ring-inset shadow-md')
                    : (isDarkMode ? 'bg-white/[0.03] hover:bg-white/[0.06]' : 'hover:shadow-sm')
            )}
            style={{
                rotateX: springX,
                rotateY: springY,
                ...
                ...(!isDarkMode ? {
                    background: isTarget ? 'linear-gradient(135deg, #eef2ff, #e0e7ff)' : 'linear-gradient(135deg, #f0f9ff, #f5f3ff)',
                    border: isTarget ? undefined : '1px solid #c7d2fe'
                } : {})
            }}
        >
...
/* ═══════════════════════════════════════════════════════════════
   Stat Card — Bento Grid Cell
   ═══════════════════════════════════════════════════════════════ */
const StatCard = ({ value, label, icon: Icon, isDarkMode, delay, color, suffix = '' }) => (
    <motion.div
        initial={{ opacity: 0, y: 20, scale: 0.96 }}
        animate={{ opacity: 1, y: 0, scale: 1 }}
        transition={{ duration: 0.5, delay, ease: [0.16, 1, 0.3, 1] }}
        className={'relative group overflow-hidden rounded-3xl p-6 transition-all duration-300 ' + (isDarkMode
    ...
    >
        ...
        <div className="relative z-10">
            <div className={'w-10 h-10 rounded-2xl flex items-center justify-center mb-4 ' + (isDarkMode ? 'bg-white/[0.05]' : 'bg-slate-50')}>
                <Icon className="w-5 h-5" style={{ color }} />
            </div>
            <div className={'text-4xl font-[200] tracking-tight leading-none tabular-nums ' + (isDarkMode ? 'text-white' : 'text-slate-900')}>
                <AnimatedNumber value={typeof value === 'string' ? parseFloat(value) || 0 : value} isDarkMode={isDarkMode} suffix={suffix} />
            </div>
            <span className={'block text-[10px] font-bold uppercase tracking-[0.2em] mt-2 ' + (isDarkMode ? 'text-slate-500' : 'text-slate-400')}>
                {label}
            </span>
        </div>
    </motion.div>
        ...
        <motion.div variants={containerAnim} initial="hidden" animate="show" className="relative max-w-7xl mx-auto w-full">
            ...
            <div className="relative z-10 space-y-8">
                ...
                <motion.div variants={itemAnim} className="mb-2">
                    <div className="flex items-center justify-between mb-5">
                        <div className="flex items-center gap-3">
                            <motion.div
                                ...
                                className={'w-10 h-10 rounded-2xl flex items-center justify-center ' + (isDarkMode ? 'bg-white/[0.05]' : 'bg-blue-100/80')}
                        ...
                        <motion.button
                            ...
                            whileTap={{ scale: 0.98 }}
                            className={'flex items-center gap-2 px-5 py-2.5 rounded-2xl text-sm font-semibold transition-all duration-300 ' + (isMapped
                    ...
                    >
                        Before building anything, look at what you have. Load the patient cohort, inspect each column, and flag anything unusual.
                    </motion.p>
                </motion.div>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-5 gap-4">
                        ...
                        <motion.div
                            className={'lg:col-span-3 rounded-3xl p-6 transition-all duration-300 overflow-hidden relative ' + (isDarkMode
                                ...
                                : 'bg-indigo-50/40 border border-indigo-100 shadow-md')}
                ...
                <motion.section variants={itemAnim}>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-8">
                        ...
                        <motion.div
                            ...
                            className={'relative group overflow-hidden rounded-3xl p-6 transition-all duration-300 ' + (isDarkMode
                                ? 'bg-white/[0.03] hover:bg-white/[0.06] border border-white/[0.06]'
                                : 'bg-indigo-50/40 border border-indigo-100 hover:shadow-md')}
                        >
                            <div
                                className="absolute -top-8 -right-8 w-24 h-24 rounded-full opacity-0 group-hover:opacity-100 transition-opacity duration-700 blur-2xl"
                            ...
                            <div className="relative z-10">
                                <div className={'w-10 h-10 rounded-2xl flex items-center justify-center mb-4 ' + (isDarkMode ? 'bg-white/[0.05]' : 'bg-slate-50')}>
                                    <AlertTriangle className="w-5 h-5" style={{ color: missingColor }} />
                                </div>
                                <div className={'text-4xl font-[200] tracking-tight leading-none tabular-nums'} style={{ color: missingColor }}>
                                    {stats.missing}
                                </div>
                                <span className={'block text-[10px] font-bold uppercase tracking-[0.2em] mt-2'} style={{ color: missingColor, opacity: 0.7 }}>
                                    {missingLabel}
                                </span>
                            </div>
                        </motion.div>
