            ...
            <div className="relative z-10 space-y-5">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-5">
                    ...
                    <motion.div variants={itemAnim} className="lg:col-span-8 space-y-5">
                        ...
                        {/* Visualization Card */}
                        <div className={'rounded-[24px] overflow-hidden relative transition-all duration-300 ' + (isDarkMode ? 'bg-white/[0.02] border border-white/[0.06] shadow-[0_4px_20px_rgba(0,0,0,0.2)]' : 'bg-white border border-slate-200 shadow-sm')}>
